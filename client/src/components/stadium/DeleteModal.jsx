    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6">
          ...
          <h2 className="text-xl font-bold text-center text-gray-900 mb-2">Delete {itemName}?</h2>
          <p className="text-center text-gray-500 text-sm">
            Are you sure you want to delete this {itemName.toLowerCase()}? This action cannot be undone, though active matches may prevent immediate deletion.
          </p>
        </div>
